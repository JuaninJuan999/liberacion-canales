                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <form wire:submit.prevent="guardar" class="p-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" wire:model.live="nombre"
                                           class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="username"
                                           class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition font-mono"
                            ...
                            <div class="flex gap-3 pt-5 mt-2 border-t border-gray-100">
                                <button type="submit"
                                        class="flex-1 flex items-center justify-center gap-2 {{ $modo === 'crear' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-amber-500 hover:bg-amber-600' }} text-white font-semibold py-2.5 rounded-xl shadow-sm transition">
                                    @if($modo === 'crear')
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                        </svg>
                                ...
                                <button type="button" wire:click="cancelar"
                                        class="px-6 flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2.5 rounded-xl transition">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <td class="px-5 py-4">
                                                <div class="flex items-center justify-center gap-1.5">
                                                    ...
                                                    <button wire:click="mostrarFormularioEditar({{ $usuario->id }})"
                                                            ...
                                                            class="p-2 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 border border-blue-200 hover:border-blue-300 transition-all">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

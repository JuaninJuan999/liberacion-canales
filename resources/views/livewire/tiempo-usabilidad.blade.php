            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900">Tiempo de Usabilidad</h1>
                            <p class="text-gray-500 mt-1 text-sm">Control del tiempo de uso del sistema por usuario</p>
                        </div>
                    </div>
                </div>
            </div>

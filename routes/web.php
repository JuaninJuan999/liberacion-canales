...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/titulacion-acido-lactico/historial', TitulacionAcidoLacticoHistorial::class)->name('titulacion-acido-lactico.historial');
        Route::get('/titulacion-acido-lactico/historial/excel', TitulacionAcidoLacticoHistorialExcelController::class)->name('titulacion-acido-lactico.historial.excel');
